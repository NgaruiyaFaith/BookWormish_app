  ...
  return (
    <div className="text-center mb-8">
      <h1 className="text-4xl md:text-5xl font-bold">
        ...
        <span className="text-teal-500 font-playfair animate-swing" style={{ fontFamily: 'Playfair Display, serif' }}>
          Book
        </span>
        <span className="text-yellow-500 text-5xl md:text-6xl" style={{ fontFamily: 'Playfair Display, serif' }}>
          Wormish
        </span>
      </h1>
